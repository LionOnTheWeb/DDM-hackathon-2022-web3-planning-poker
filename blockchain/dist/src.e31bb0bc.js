...
var CONTRACT_NAME = "dev-1645118305363-86868158803255" || 'blockchain';
  ...
  switch (env) {
    ...
    case 'local':
      return {
        ...
        keyPath: "".concat("/Users/gjeelal", "/.near/validator_key.json"),
        ...
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            return new _nearApiJs.Contract(window.walletConnection.account(), nearConfig.contractName, {
              ...
              viewMethods: ["getGreeting", "setGreeting", "didParticipate", "getAllPrompts", "getVotes", "getUrl", "getCandidatePair",,],
